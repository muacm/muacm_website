...
const Team = () => {
  ...
  const [council_data] = useState(
    Council_Member_Details.Council_Member_Details.Council
  );
  const [core_data] = useState(Core_Member_Details.Core_Member_Details.Core);
  const [executive_data] = useState(
    Executive_Member_Details.Executive_Member_Details.Executive
  );
