  ...
  return (
    <div className="Home">
      ...
      <div className="button_layer">
        ...
        <button className="secondaryButton">Check Past Events</button>
      </div>
      ...
      <div className="content-section" id="about-acm">
        ...
        <p className="content">
          ...
          international scientific and industrial computer society. Through its
          many Special Interest Groups, the ACM fosters research and
          ...
          computing enthusiasts. ACM conducts various worldwide competitions and
          seminars, where we have learned and scholarly speakers to provide us
          with the opportunity to increase our knowledge and expand our
          horizons. ACM provides us with one of the most enriching digital
          ...
          leads us to the pathway following which in the near future, world’s
          biggest problems will be solved using computing.
        </p>
      </div>
