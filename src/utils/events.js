  ...
  Events: [
    {
      ...
      event_description: "Medicaps University ACM Student Chapter (MUACM) in collaboration with Google Developers Group, Indore is hosting a 10 day Web Development BootCamp! Creating a web app using HTML, CSS, React and how to use Git and GitHub will be taught from scratch.",
