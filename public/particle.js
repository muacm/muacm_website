...
Particle.prototype.tick = function (tickX, tickY, ctx) {
  ...
  var tickDistanceX = tickX - this.x;
  var tickDistanceY = tickY - this.y;
  var targetDistance = Math.sqrt(
    targetDistanceX * targetDistanceX + targetDistanceY * targetDistanceY
  );
  var tickDistance = Math.sqrt(
    tickDistanceX * tickDistanceX + tickDistanceY * tickDistanceY
  );
